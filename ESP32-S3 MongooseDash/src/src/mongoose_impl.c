...
struct attribute s_relais_attributes[] = {
  {"relais1", "bool", NULL, offsetof(struct relais, relais1), 0, false},
  {"relais2", "bool", NULL, offsetof(struct relais, relais2), 0, false},
  {"relais3", "bool", NULL, offsetof(struct relais, relais3), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct apihandler_data s_apihandler_relais = {{"relais", "data", false, 3, 3, 0UL}, s_relais_attributes, sizeof(struct relais), (void (*)(void *)) glue_get_relais, (void (*)(void *)) glue_set_relais};
...
static struct apihandler *s_apihandlers[] = {
  ...
  (struct apihandler *) &s_apihandler_relais,
